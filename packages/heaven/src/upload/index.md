...
- <font color="#346fff">V2.0 精简代码，剔除 pic-list/pic/text 三份代码</font>
- <font color="#346fff">V2.0 优化配置，新增 drag 属性即可改为拖拽上传，新增上传文本和校验内容配置，修改拖拽上传图标</font>
...
<code src="./demos/crop-image.tsx" />

### 自定义进度条样式

<code src="./demos/customize-progress-bar.tsx" />

### 已上传的文件列表

<code src="./demos/defaultFileList.tsx" />
...
<code src="./demos/file-type.tsx" />

### 完全控制的上传列表

<code src="./demos/fileList.tsx" />

### 限制数量

<code src="./demos/max-count.tsx" />

### 照片墙

<code src="./demos/picture-card.tsx" />

### 图片列表样式

<code src="./demos/picture-style.tsx" />

### 自定义预览

<code src="./demos/preview-file.tsx" />

### 上传前转换文件

<code src="./demos/transform-file.tsx" />

### 自定义交互图标

<code src="./demos/upload-custom-action-icon.tsx" />

### 手动上传

<code src="./demos/upload-manually.tsx" />

### 只上传 png 图片

<code src="./demos/upload-png-only.tsx" />

### 阿里云 OSS

<code src="./demos/upload-with-aliyun-oss.tsx" />
...
| uploadText            | 上传文案说明                                                                                                                                                                                                                                                                                           | `ReactNode` \| `string`                                                                                                                                                                                                | 上传文件                                                                                                                                 |                 |
| uploadHint            | 上传限制说明                                                                                                                                                                                                                                                                                           | `ReactNode` \| `string`                                                                                                                                                                                                | -                                                                                                                                        |                 |
