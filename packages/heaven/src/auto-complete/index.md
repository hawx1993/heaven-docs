...
<code src="./demos/certain-category.tsx" />

### 自定义输入组件

<code src="./demos/custom.tsx" />

<code src="./demos/form-debug.tsx" />

### 不区分大小写

<code src="./demos/non-case-sensitive.tsx" />

### 自定义选项

<code src="./demos/options.tsx" />

### 查询模式 - 不确定类目

<code src="./demos/uncertain-category.tsx" />
